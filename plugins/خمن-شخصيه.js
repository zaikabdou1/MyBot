...
module.exports = {
  command: 'خمن',
  category: 'ترفيه',
  description: 'لعبة تخمين الشخصيه من الشرح الخاص بها 🧠',
  async execute(sock, m) {
    ...
    const characters = [
      ...
      { name: "ايرين", hint: "صاحب عبارة 'سأقضي على كل العمالقة'، يتحول لعملاق." },
      { name: "ميكاسا", hint: "تحمي إيرين دائمًا، مقاتلة قوية وباردة الأعصاب." },
      { name: "ارمين", hint: "ذكي جدًا، صديق إيرين المقرب، لديه قوة الإقناع." },
      ...
      { name: "ايرزا", hint: "ساحرة المدرعات، قوية جدًا ومخيفة عندما تغضب." },
      { name: "تانجيرو", hint: "صياد شياطين طيب، يريد إعادة أخته لطبيعتها." },
      { name: "نيزوكو", hint: "أخته تحولت لشيطان لكنها لا تؤذي البشر." },
      { name: "اينوسكي", hint: "يرتدي رأس خنزير، مقاتل عنيف وسريع." },
      { name: "زينيتسو", hint: "جبان لكنه يصبح قويًا جدًا عندما يغمى عليه." },
      { name: "اوبيتو", hint: "كان صديق كاكاشي، أصبح شريرًا بسبب الخيانة." },
      { name: "مادارا", hint: "من أقوى شخصيات الأوتشيها، يريد السلام بطريقته الخاصة." },
